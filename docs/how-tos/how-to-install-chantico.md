...
1. [How to register an SNMP device type](how-to-register-an-snmp-device-type.md) - Upload the MIB files to use and make `.yaml` files for SNMP devices. Also see the example at `config/samples/chantico_v1alpha1_snmpdevice.yaml`.
